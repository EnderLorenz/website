...
function draw() {
  background(256)
  slider1.position(25,canvasSize-130);
  slider2.position(canvasSize/3,canvasSize-120);
  slider3.position(1.9*canvasSize/3,canvasSize-100);
  ...
  stroke(20, 62, 22);
  line(width/3, height-250, width/3, height-450);
  branch(width/3, height-450, 50, -0, 0.00001, order);
}
...
function startStop() {
  ...
  button.position(width-button.width-10, height-150);

  button2.mousePressed(stopSketch);
  button2.position(width-button2.width-10, height-100)
