...
function setup() {
  ...
  canvas.parent('img');
  background(0)
  slider1 = createCSlider(-5, 4, 0, .0001);
  slider2 = createCSlider(-5, 4, 0, .0001);
  slider3 = createCSlider(0, 2.5, 2.1, .0001);
  startStop();
  pixelDensity(1);
}
...
function draw() {
  ...
  background(255);
  slider1.position(25,canvasSize);
  slider2.position(canvasSize/3,canvasSize+25);
  slider3.position(1.9*canvasSize/3,canvasSize+50);
  ...
  loadPixels();
  for (var xi = 25; xi < width-25; xi++) {
    for (var yi = 25; yi < height-25-150; yi++) {
      var x0 = map(xi, 25, width-25, x_center-length, x_center+length);
      var y0 = map(yi, 25, height-25-150, y_center-length, y_center+length);
      var x = 0;
      var y = 0;
      var x2 = 0;
      var y2 = 0;
...
//   slider1 = createSlider(-5, 5, .7, .0001);
//   slider1.position(10,canvasSize*.99);
//   slider2 = createSlider(-5, 5, .7, .0001);
//   slider2.position(3*canvasSize/5,canvasSize*.99);
//   slider3 = createSlider( 0, 4, 4, .01);
//   slider3.position(2*canvasSize/7,canvasSize+30);
//   // startStop();
//   pixelDensity(1);
//   text('x-center', 10, canvasSize*.99-65);
//   text('zoom', 3*canvasSize/8, canvasSize*.99-30);
//   text('y-center', 2*canvasSize/3, canvasSize*.99-65);
...
//   length = slider3.value();
//   loadPixels();
//   for (var xi = 0; xi < width*.7; xi++) {
//     for (var yi = 0; yi < height*.7; yi++) {
//       var x0 = map(xi, 0, width, x_center-length, x_center+length);
//       var y0 = map(yi, 0, height, y_center-length, y_center+length);
//       var x = 0;
//       var y = 0;
//       var x2 = 0;
//       var y2 = 0;
...
//   button2.mousePressed(stopSketch);
//   button2.position(width-100, height-button2.height-150)
