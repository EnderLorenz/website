function Graph(ctx, xRange, yRange) {
    ...
    this.graph = function() {
        ...
        // x_max, y0 label
        this.ctx.beginPath();
        this.ctx.moveTo(xGraph[1] + xGraph[0] - bottomX, yGraph[1]+leftY);
        this.ctx.lineTo(xGraph[1] + xGraph[0] - bottomX, yGraph[1]-leftY);
        this.ctx.stroke();
        if (Math.abs(this.xMax) > 10) fix = 0;
        else fix = 1;
        this.ctx.fillText(this.xMax.toFixed(fix), xGraph[1] + xGraph[0] - bottomX, yGraph[1] + 3*bottomY);
        ctx.textAlign = "end";
        // x0,y_mid label
        this.ctx.beginPath();
        ...
        this.ctx.fillText(((this.yMin+this.yMax)/2).toExponential(2), xGraph[0]-6, (yGraph[1]+yGraph[0])/2+3);
        ctx.textAlign = "end"; 
        // x0,y_max label
        this.ctx.beginPath();
        ...
        this.ctx.fillText(this.yMax.toExponential(2), xGraph[0]-6, yGraph[0]+13);
        ctx.textAlign = "end"; 
        //x0,y_min label
        this.ctx.beginPath();
        ...
        this.ctx.fillText(this.yMin.toExponential(2), xGraph[0]-6, yGraph[1]- yGraph[0] - bottomY);
        ctx.textAlign = "end"; 
    }
